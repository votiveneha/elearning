...
<script>
      ...
      // Remove the redundant buttons from toolbar groups defined 
        ...
        CKEDITOR.replace('question_multipart_content-0', {
      ...
      // Remove the redundant buttons from toolbar groups defined 
        ...
        CKEDITOR.replace('multipart_questions_options-0', {
...
var multipart_question_array = [];
function add_options_one(){
  
  $(".multipart_option_div-"+question_count).append('<textarea name="multipart_questions_options[]" class="materialize-textarea" id="multipart_questions_options-'+option_count+question_count+'"></textarea>');
  //multipart_question_array({'id':5});
  //alert(question_count);
  var multipart_questions = CKEDITOR.instances["question_multipart_content-0"].getData();
  alert(multipart_questions);
  
  //console.log("multipart_questions",multipart_questions);
  //console.log("question_count",question_count);

  CKEDITOR.replace('multipart_questions_options-'+option_count+question_count, {
...
function addQuestions(){
  ...
  $(".multi_que_div").append('<div class="multi_que_content-'+question_count+'"><div class="col-md-12"><div class="form-group"><label>Question Content</label><div class="input-group"><textarea name="new_question_title[]" class="materialize-textarea" id="question_multipart_content-'+question_count+'"></textarea></div><br><div class="preview_latex_button"><button type="button" class="btn btn-primary" id="myBtn">Preview Latex</button></div><div class="preview_latex_error" style="color:red"></div></div></div><div class="col-md-12"><div class="form-group"><label>Options</label><div class="input-group"><textarea name="multipart_questions_options[]" class="materialize-textarea" id="multipart_questions_options-'+question_count+'"></textarea><div class="multipart_option_div-'+question_count+'"></div></div><br><div class="preview_latex_button"><button type="button" class="btn btn-primary" id="myBtn">Preview Latex</button></div><div class="preview_latex_button"><button type="button" class="btn btn-primary" id="myBtn" onclick="add_options_one()">Add Options</button></div><div class="preview_latex_error" style="color:red"></div></div></div><div class="col-md-4"><div class="form-group"><label>Marks</label><div class="input-group"><input type="text" name="marks" class="form-control"></div></div></div>');

    CKEDITOR.replace('question_multipart_content-'+question_count, {
      ...
      CKEDITOR.replace('multipart_questions_options-'+question_count, {
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <form action="{{ url('/admin/post_questions_bank1') }}? @if($question_type) question_type={{ $question_type }} @endif" id="question_form" method="post">
                      {!! csrf_field() !!}
          ...
          @endif
              ...
              <div class="multipart_questions_div" style="display: none;">
                <div class="multi_que_content">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Question Content</label>
                      <div class="input-group">
                        <textarea name="new_question_title[]" class="materialize-textarea" id="question_multipart_content-0"></textarea>
                      </div><br>
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      <label>Options</label>
                      <div class="input-group">
                        <textarea name="multipart_questions_options[]" class="materialize-textarea" id="multipart_questions_options-0"></textarea>
                        <div class="multipart_option_div-0"></div>
                      </div><br>
                      ...
                      <div class="preview_latex_button">
                        <button type="button" class="btn btn-primary" id="myBtn" onclick="add_options_one()">Add Options</button>
                      </div>
                      <div class="preview_latex_error" style="color:red"></div>
                    </div>
                  </div>
                ...
                <div class="multi_que_div"></div>
                <div class="preview_latex_button">
                  <button type="button" class="btn btn-primary" id="myBtn" onclick="addQuestions()">Add Questions</button>
                </div>
           ...
           <div class="card-footer">
            <input type="button" id="submit_btn" class="btn btn-primary" value="Submit" id="">
          </div>
        </form>
            <!-- /.row -->
          </div>
